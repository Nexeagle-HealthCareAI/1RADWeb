...
export default function TechnicianPage() {
  ...
  const renderQueue = () => (
    <div className="queue-container board-padding" style={{ paddingTop: '80px' }}>
      ...
      {/* Control & Recon Bar */}
      <div className="filter-bar responsive-control-bar" style={{ background: '#f8f9fa', padding: '20px', borderRadius: '12px', border: '1px solid #eee', marginBottom: '30px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px', alignItems: 'center' }}>
