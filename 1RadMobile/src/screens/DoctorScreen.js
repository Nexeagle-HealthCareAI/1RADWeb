      ...
      <ScrollView style={styles.content} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.header}>
          <View style={styles.iconContainer}>
            <Stethoscope size={32} color={COLORS.cyan} strokeWidth={2.5} />
          </View>
          <Text style={styles.title}>DOCTOR MODULE</Text>
          <Text style={styles.subtitle}>Clinical Operations & Patient Care</Text>
        </View>
        ...
        <View style={styles.featureList}>
          ...
          <View style={styles.featureItem}>
            ...
            <Text style={styles.featureText}>Patient Records</Text>
          </View>
          <View style={styles.featureItem}>
            <Text style={styles.featureBullet}>•</Text>
          ...
          <View style={styles.featureItem}>
            <Text style={styles.featureBullet}>•</Text>
            <Text style={styles.featureText}>Lab Results Review</Text>
          </View>
          <View style={styles.featureItem}>
            <Text style={styles.featureBullet}>•</Text>
          ...
          <View style={styles.featureItem}>
            <Text style={styles.featureBullet}>•</Text>
            <Text style={styles.featureText}>Consultation History</Text>
          </View>
        </View>
